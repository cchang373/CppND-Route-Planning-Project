...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    // Store the found noded in the RoutePlanner's start_node and end_node attributes.
	start_node = &m_Model.FindClosestNode(start_x, start_y);
  	end_node = &m_Model.FindClosestNode(end_x, end_y);
}


// CalculateHValue method implementation
// - The distance method to the end_node for the h value.
...
// - CalculateHValue for implementation of h-value calculation
...
// A* Search algorithm
// - AddNeighbors method to add all of the neighbors of the current node to the open_list.
